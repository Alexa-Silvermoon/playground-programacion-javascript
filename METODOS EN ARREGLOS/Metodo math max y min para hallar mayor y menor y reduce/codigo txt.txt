...
console.log('usando .reduce() el mayor es: ', mayor);

console.log('----------------------------------');

console.log('usando Math.max() el mayor es: ', Math.max(...numbers));
console.log('usando Math.min() el menor es: ', Math.min(...numbers));
